---
name: flow
description: Implement specs, manage backlog, brainstorm — routes each path (implement / --add / --ideas / --clean / --condense) loading only its reference. Invoke as /flow [spec#|--ideas|--add|--clean|--condense|description].
---
...
|---|---|
| `/flow <spec id>` or `/flow <description>` | `reference/implement.md` |
| `/flow --add` | `reference/add.md` (+ `reference/authoring.md`) |
| `/flow --condense …` | `reference/condense.md` (+ `reference/authoring.md`) |
| `/flow --clean` | `reference/clean.md` |
| `/flow` (no args) | *inline below* |
| `/flow --ideas` | *inline below* |
