...
## Phase 1 — Features
- **1.17** Descriptive spec filenames — `<id>-<slug>` files, config knob, opt-in rename migration — `IN PROGRESS` — [detail](specs/1.17-descriptive-spec-filenames/1.17-descriptive-spec-filenames.md)
